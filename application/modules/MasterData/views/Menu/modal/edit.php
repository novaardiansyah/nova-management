  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= base_url('masterData/menu/editData'); ?>" method="post" enctype="multipart/form-data" id="form-editData" class="pe-4">
          <div class="mb-3 row">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-sm btn-primary" onclick="return editData()">Save</button>
      </div>
    </div>
  </div>
</div>